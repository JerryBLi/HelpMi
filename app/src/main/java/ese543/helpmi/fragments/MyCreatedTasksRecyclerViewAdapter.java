...
import ese543.helpmi.fragments.MyCreatedTasksFragment.OnListFragmentInteractionListener;
 ...
 */
public class MyCreatedTasksRecyclerViewAdapter extends RecyclerView.Adapter<MyCreatedTasksRecyclerViewAdapter.ViewHolder> {

    private final List<UserTask> mValues;
    private final MyCreatedTasksFragment.OnListFragmentInteractionListener mListener;

    public MyCreatedTasksRecyclerViewAdapter(List<UserTask> items, MyCreatedTasksFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }

    @Override
    public MyCreatedTasksRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_task, parent, false);
        return new MyCreatedTasksRecyclerViewAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final MyCreatedTasksRecyclerViewAdapter.ViewHolder holder, int position) {
